      ...
      <Container fluid>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Importer</p>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Vehicle</p>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">C&F Agent</p>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Pilot</p>
        ...
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Weight Scale</Card.Title>
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Weight Statistics</Card.Title>
